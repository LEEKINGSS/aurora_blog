...
import com.aurora.strategy.impl.BaiduAuditingStrategyImpl;
...
import static com.aurora.constant.BaiduAuditConstant.NORMAL;
...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    @Autowired
    private BaiduAuditingStrategy baiduAuditingStrategy;
    ...
    public void saveComment(CommentVO commentVO) {
        ...
        String textContent = HTMLUtil.filter(commentVO.getCommentContent());
        commentVO.setCommentContent(textContent);
        FindingsOfAuditDTO findingsOfAuditDTO = baiduAuditingStrategy.textAudit(textContent);
        if (findingsOfAuditDTO.getConclusionType() != NORMAL) {
